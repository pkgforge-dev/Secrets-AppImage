...
[![Latest Stable Release](https://img.shields.io/github/v/release/pkgforge-dev/Secrets-AppImage)](https://github.com/pkgforge-dev/Secrets-AppImage/releases/latest)
...
* [Upstream URL](https://gitlab.gnome.org/World/secrets)
